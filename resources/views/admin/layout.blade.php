...
<head>
  ...
  <title>bulding admin panel</title>
  <link rel="Icon" href="{{url('/')}}/img/log.png">
  <!-- Font Awesome -->
...
<header>
      ...
      <div class="position-sticky">
        <div class="list-group list-group-flush mx-3 mt-4">
          ...
          <a href="{{route('product.index')}}" class="list-group-item list-group-item-action py-2 ripple <?php if(route('product.index') == $absolute_url){echo("active");}?>"><i
              class="fas fa-chart-bar fa-fw me-3"></i> <span>گالری</span></a>
    ...
    <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
      ...
      <div class="container-fluid">
        ...
        <!-- Brand -->
        <a class="navbar-brand" href="{{route('bulding.index')}}">
          <img src="{{url('/')}}/img/log.png" height="50" alt="" loading="lazy" />
        </a>
        <!-- Search form -->
